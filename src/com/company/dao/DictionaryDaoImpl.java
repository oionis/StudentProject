...
public class DictionaryDaoImpl implements DictionaryDao {
    ...
    private static final String GET_STREET = "SELECT street_code, street_name " +
            "FROM sp_street WHERE LOWER(street_name) LIKE LOWER(?)";

    private static final String GET_PASSPORT = "SELECT * " +
            "FROM sp_passport_office WHERE p_office_area_id = ?";

    private static final String GET_REGISTER = "SELECT * " +
            "FROM sp_register_office WHERE r_office_area_id = ?";

    private static final String GET_AREA = "SELECT * " +
            "FROM sp_country_struct WHERE area_id like ? and area_id <> ?";
    ...
    private String buildParam (String areaId) throws SQLException{
        ...
        throw new SQLException("Invalid parametrs 'areaId':" + areaId);
    }
}
